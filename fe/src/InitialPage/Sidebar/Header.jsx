...
import { selectUser, selectIsAuthenticated, logoutUser } from "../../core/redux/authSlice";
...
const Header = () => {
  ...
  const getUserDisplayName = () => {
    ...
    return user.givenName || user.userName || "User";
  };
  ...
  const shouldShowBranchInfo = () => {
    return user && user.role && (user.role === 2 || user.role === 3) && user.branch;
  };
              ...
              <form action="#" className="dropdown">
                ...
                >
                  ...
                  <div className="search-info">
                    ...
                    <p>
                      Cách thay đổi số lượng sản phẩm từ 0 đến 200 trong quản lý kho
                    </p>
                    <p>Thay đổi tên sản phẩm</p>
                  </div>
                  <div className="search-info">
                    <h6>
                      <span>
              ...
              >
                <span className="user-info">
                  ...
                  <span className="user-detail">
                    <span className="user-name">{getBranchName()}</span>
                    <span className="user-role">Chi nhánh</span>
                  </span>
                </span>
              </Link>
            </li>
          ...
          <li className="nav-item dropdown nav-item-box">
            ...
            <div className="dropdown-menu notifications">
              ...
              <div className="topnav-dropdown-footer">
                <Link to="/activities">Xem tất cả thông báo</Link>
              </div>
            </div>
          </li>
          {/* /Notifications */}
            ...
            <div className="dropdown-menu menu-drop-user">
              <div className="profilename">
                ...
                <Link className="dropdown-item" to={route.route}>
                  <i className="me-2" data-feather="user" /> Hồ sơ của tôi
                </Link>
